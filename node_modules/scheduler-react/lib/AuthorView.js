...
var AuthorView = (_temp = _class = function (_Component) {
    _inherits(AuthorView, _Component);

    function AuthorView(props) {
        _classCallCheck(this, AuthorView);

        return _possibleConstructorReturn(this, (AuthorView.__proto__ || Object.getPrototypeOf(AuthorView)).call(this, props));
    }

    _createClass(AuthorView, [{
        key: 'render',
        value: function render() {
            ...
            var width = schedulerData.getResourceTableWidth();
            ...
            var resourceList = displayRenderData.map(function (item) {
                ...
                var a = slotClickedFunc != undefined ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        item.slotAuthor ? item.slotAuthor : 'No Assignee'
                    )
                ) : _react2.default.createElement(
                    'span',
                    { className: 'slot-cell' },
                ...
                var slotItem = _react2.default.createElement(
                    'div',
                    { title: item.slotAuthor ? item.slotAuthor : 'No Assignee', className: 'overflow-text header2-text', style: { textAlign: "left" } },
                    a
                );
