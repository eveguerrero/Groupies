...
var _AuthorView = require('./AuthorView');

var _AuthorView2 = _interopRequireDefault(_AuthorView);
    ...
    _createClass(Scheduler, [{
        ...
        value: function render() {
            ...
            if (showAgenda) {
                ...
                var _resourceTableWidth = schedulerData.getResourceTableWidth();
                var schedulerContainerWidth = width - _resourceTableWidth + 1;
                ...
                var schedulerContentStyle = { overflow: 'auto', margin: "0px", position: "relative", paddingBottom: contentPaddingBottom, backgroundColor: '#F1F1F1' };
                var resourceContentStyle = { border: "1px solid #e9e9e9", overflowWrap: 'break-word', width: _resourceTableWidth + resourceScrollbarWidth - 2, margin: '0px -' + contentScrollbarWidth + 'px 0px 0px' };
                ...
                tbodyContent = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'td',
                        { style: { width: _resourceTableWidth, verticalAlign: 'top' } },
                        _react2.default.createElement(
                            'div',
            ...
            var projectImg = config.projectImage ? config.projectImage : config.defaultImg;
            ...
            if (config.headerEnabled) {
                schedulerHeader = _react2.default.createElement(
                    _row2.default,
                    { type: 'flex', align: 'middle', justify: 'space-between', style: { border: '2px solid #e9e9e9', paddingRight: '10px' } },
                    leftCustomHeader,
                    _react2.default.createElement(
                        _col2.default,
                        null,
                        _react2.default.createElement(
                            'div',
                            { style: { width: resourceTableWidth, borderRight: '2px solid #e9e9e9', textAlign: 'center' } },
                            _react2.default.createElement(
                                'div',
                                { className: 'container-grid' },
                                _react2.default.createElement('div', { className: 'image-header', style: { backgroundImage: 'url(' + projectImg + ')' } }),
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { className: 'text-header-link', href: projectUrl, target: '_blank' },
                                        'Open in Gitlab'
                                    )
                                ),
                                _react2.default.createElement(_icon2.default, { type: 'more', style: {}, className: 'icon-header' })
                            )
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'header-col2' },
                            _react2.default.createElement(
                                'div',
                                { className: 'header2-text' },
                                _react2.default.createElement(_icon2.default, { type: 'caret-left', style: { color: '#CACCCD', marginRight: "8px" }, className: 'icon-nav',
                                    onClick: this.goBack }),
                                calendarPopoverEnabled ? _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'header2-text-label', style: { fontWeight: 'bold', cursor: 'pointer' } },
                                        dateLabel
                                    )
                                ) : _react2.default.createElement(
                                    'span',
                                ...
                                _react2.default.createElement(_icon2.default, { type: 'caret-right', style: { color: '#CACCCD', marginLeft: "8px" }, className: 'icon-nav',
                                    onClick: this.goNext })
                            )
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            RadioGroup,
                            { style: { alignItems: 'flex-end', marginRight: "8px" }, defaultValue: defaultValue, size: 'default', onChange: this.onViewChange },
                            radioButtonList
                        )
                    ),
                    rightCustomHeader
            ...
            return _react2.default.createElement(
                'table',
                { id: 'RBS-Scheduler-root', className: 'scheduler', style: { width: width + 'px', minWidth: '80px' } },
                _react2.default.createElement(
                    'thead',
                    null,
                    _react2.default.createElement(
