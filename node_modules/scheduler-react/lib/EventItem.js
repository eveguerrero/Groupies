...
var EventItem = (_temp = _class = function (_Component) {
    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            var labelText = schedulerData.behaviors.getEventLabelFunc(schedulerData, eventItem);
            ...
            var diffTime = Math.abs(new Date(start.format('M/D/YYYY')) - new Date(end.format('M/D/YYYY')));
            ...
            var eventItemTemplate = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'span',
                    { style: { marginLeft: '30px', lineHeight: config.eventItemHeight + 'px' } },
                    labelText
                ),
                _react2.default.createElement('img', { className: 'circle', src: img, style: { marginLeft: '50px' } })
            );
            ...
            var a = _react2.default.createElement(
                'a',
                { className: 'timeline-event', style: { left: left, width: width, top: '35%' }, onClick: function onClick() {
