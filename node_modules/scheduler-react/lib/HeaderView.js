            ...
            if (cellUnit === _index.CellUnits.Hour) {
                headers.forEach(function (item, index) {
                    if (index % minuteStepsInHour === 0) {
                        ...
                        var pFormattedListDay = config.nonAgendaOtherCellHeaderFormatDay.split('|').map(function (item) {
                            return datetime.format(item);
                        });
                        ...
                        if (typeof nonAgendaCellHeaderTemplateResolver === 'function') {
                            ...
                            var pListDay = pFormattedListDay.map(function (item, index) {
                                return _react2.default.createElement(
                                    'div',
                                    { key: index },
                                    item
                ...
                headerList = headers.map(function (item, index) {
                    ...
                    var isCurrentDate = datetime.isSame(new Date(), 'day');
                    ...
                    if (item.isFriday) {
                        style = _extends({}, style, { borderRight: '2px solid #F08421' });
                    }
                    ...
                    if (isCurrentDate) style = _extends({}, style, { backgroundColor: config.currentDayBgColor });
