            ...
            var resourceList = displayRenderData.map(function (item) {
                ...
                var a = slotClickedFunc != undefined ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { className: 'slot-text', style: { width: width }, onClick: function onClick() {
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'slot-text header4-text overflow-text', style: { width: width - 80 } },
                        item.slotName
                    )
                );
                var slotItem = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'overflow-text header2-text', style: { textAlign: "left", color: '#F08421', fontSize: '14px', marginBottom: '15px' } },
                        item.slotIssue ? item.slotIssue : ''
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'overflow-text header2-text', style: { textAlign: "left" } },
                        a
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'overflow-text header2-text', style: { textAlign: "left", marginTop: '15px' } },
                        _react2.default.createElement(
                            'span',
                            { className: ' overflow-text header3-text' },
                            'Assignee:'
                        ),
                        ' ',
                        item.slotAuthor ? item.slotAuthor : 'Unassignee'
                    )
                );
                ...
                var tdStyle = { height: item.rowHeight, display: 'inline-block' };
                if (item.groupOnly) {
